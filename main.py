...
class AllienInavasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if colisions:
            for aliens in colisions.values():
                self.stats.score = int(self.stats.score) + self.settings.alien_points * len(aliens)
            self.stats.score = str(self.stats.score)
            self.sb.prep_score()
    ...
    def _update_aliens(self):
        ...
        # Шукати, чи якийсь з прибульців досяг нижнього краю екрана
    ...
    def _check_aliens_bottom(self):
        """Перевірити, чи не досяг якийсь прибулець низу екрана"""
